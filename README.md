...
## 핵심 아이디어 / 접근 방법
- ViDE의 “시각적 반복 구조 감지” 원리를 기반으로 합니다.
  - **렌더링 정보(위치/크기 등)** 를 활용하여 반복되는 상품 블록을 찾습니다.
  - 상품 블록에 해당하는 패턴(텍스트 및 이미지 포함)에 대해서만 부분 렌더링을 진행하여 기존보다 렌더링 시간을 줄입니다.
